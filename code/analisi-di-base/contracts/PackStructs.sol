...
contract PackDivided {
    ...
    function setPerson(uint256 _id, address _owner, uint256 _dna, uint256 _height, uint256 _weight, uint256 _creationTime) external {
        owners[_id] = _owner;
        dnas[_id] = _dna;
    ...
    function getPerson(uint256 _id) external view returns(address _owner, uint256 _dna, uint256 _height, uint256 _weight, uint256 _creationTime) {
        _owner = owners[_id];
        _dna = dnas[_id];
        _height = heights[_id];
        _weight = weights[_id];
...
contract PackStructs {
    ...
    function setPerson(uint256 _id, address _owner, uint256 _creationTime, uint256 _height, uint256 _weight, uint256 _dna) external {
