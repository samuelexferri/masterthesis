...
library AssemblyVectorSum {
	// Funzione meno efficiente perché l'ottimizzatore fallisce a rimuovere i bounds checks sull'accesso all'array
	...
	// Il valore 0x20 deve essere aggiunto all'array perché il primo slot contiene la length
