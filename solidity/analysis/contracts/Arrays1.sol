...
contract Arrays1 {
	...
	function fixedByteArray() public returns (uint256) {
	...
	function dynamicBytesArray() public returns (uint256) {
	...
	function fixedArray() public returns (uint256) {
	...
	function dynamicArray() public returns (uint256) {
